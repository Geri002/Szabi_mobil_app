...
type FailScreenNavigationProp = RouteProp<AppStackParamList, 'FailScreen'>;

export default function FailScreen() {
  const route = useRoute<FailScreenNavigationProp>();
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Előfizetés sikertelen</Text>
